...
export default function NewBornSleep() {
  return (
    <div >
      <SH>Newborn Sleep</SH>
       <div className=" flex justify-center  mb-10">
        <img src="/support/baby-sleeping.jpg" alt="Newborn Sleep" width={640} />
      ...
      <SH2>How Much Sleep to Expect?</SH2>
      <SP>
      ...
      <SH2>Establishing a Sleep Schedule: Tips</SH2>

      <SH3>1. Bright Light During the Day, Dim Light at Night</SH3>
      <SP>
      ...
      <SH3>4. Creating a Comfortable Sleep Environment</SH3>
      <SP>
      ...
      <SH3>7. The Relationship Between Feeding and Sleep</SH3>
      <SP>
      ...
      <SH3>8. Let Them Wake Up Briefly</SH3>
      <SP>
      ...
      <SH2>Patience and Flexibility: The Most Essential Signs</SH2>
      <SP>
